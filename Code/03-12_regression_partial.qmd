...
- Complete formal analysis of four models:
  ...
  - quadratic  
  - linear-plateau  
  The first three models are linear models - because their parameters are linear. 
...
```
yield stagnates after 73, which is the break point (xs) as predicted by the model. 
# 7) Model comparison  
## a) Visual comparison
```{r comparison plot}
